...
export default function NoteList({ 
  ...
  if (isLoading) {
    ...
    return (
      <div className="p-4 text-center">
        <div className="sidebar-avatar mx-auto mb-3">
  ...
  return (
    <div className="flex flex-col h-full sidebar-safe-area">
        ...
        <div className="relative">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors flex-shrink-0"
            >
                ...
                <div className="flex items-start justify-between min-h-0">
                  <div className="flex-1 min-w-0 pr-2">
                    <div className="flex items-center space-x-2 mb-1 flex-wrap">
                      <h3 className="font-medium text-gray-800 truncate text-sm flex-1 min-w-0">
                        {note.title || 'Untitled'}
                      </h3>
                      {selectedNote?.id === note.id && (
                        <span className="status-dot status-success flex-shrink-0" />
                      )}
                    </div>
                  ...
                  <button
                    ...
                    className="opacity-75 sm:opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg touch-target flex items-center justify-center smooth-transition min-w-[40px] min-h-[40px]"
                    title="Delete note"
                  >
